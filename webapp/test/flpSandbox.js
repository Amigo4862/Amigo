		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#igiprojectigi-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"igiprojectigi-display": {
								"semanticObject": "igiprojectigi",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=igi.projectigi",
									"url": sap.ui.require.toUrl("igi/projectigi")
								}
							}
						}
					}
